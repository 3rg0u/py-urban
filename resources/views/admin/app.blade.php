...
<div class="main-container d-flex">
    <div class="sidebar sidebar-custome" id="side_nav">
        ...
        <ul class="list-unstyled px-2">
            <li><a href="{{route('services.pernament.index')}}"  class="text-decoration-none px-3 py-2 d-block"><i class="fal fa-list"></i>Dịch vụ cố định</a></li>
        </ul>
        <ul class="list-unstyled px-2">
            <li><a href="{{route('services.subscription.index')}}"  class="text-decoration-none px-3 py-2 d-block"><i class="fal fa-list"></i>Dịch vụ định kỳ</a></li>
        </ul>
        <ul class="list-unstyled px-2">
            <li><a  class="text-decoration-none px-3 py-2 d-block"><i class="fal fa-list"></i>Quản lý hóa đơn</a></li>
        </ul>
        <ul class="list-unstyled px-2">
            <li><a  class="text-decoration-none px-3 py-2 d-block"><i class="fal fa-list"></i>Quản lý cư dân</a></li>
        </ul>
