...
<div class="card">
    ...
    <clipPath id="clip0_993_25">
        ...
        <button class="btn btn-danger" style="margin-top: 10px" data-bs-toggle="modal"
            data-bs-target="#_leaveService_{{$service->id}}">
            Hủy đăng ký
        </button>
    </div>
    </div>
        @include('resident.service.registration.components.leave', ['service' => $service])
    @endforeach
</div>
